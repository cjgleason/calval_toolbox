...
test=nc_open('D:\\OneDrive -\ University of Massachusetts\\calval\\Toolbox\\calval_toolbox\\Willamette\\rivertile.nc')
...
points(c(node_ids[point1],
         ...
         c(this_node_wse[point1],
           ...
           this_node_wse[point3],
           this_node_wse[point4],
           this_node_wse[point5] )  ,col='red'  ,lwd=10   )
...
this_node_wse_new = this_node_wse - 1 - runif(length(this_node_wse),0.0,0.05)
