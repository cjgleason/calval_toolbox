Sys.umask('002')
create_gnss_dataframe= function(log_file,gnss_drift_data_directory,output_directory,naughty_bin_directory){
  library(ncdf4)
  library(stringr)
  library(dplyr)
...
gnss_drift_data_directory = '/nas/cee-water/cjgleason/calval/Processed data/T2/From Andy/'
raw_gnss = list.files(gnss_drift_data_directory)
output_directory = '/nas/cee-water/cjgleason/calval/Processed data/T2/Munged drifts/'
naughty_bin_directory = '/nas/cee-water/cjgleason/calval/Processed data/T2/Flagged drifts/'

for (i in 1:length(raw_gnss)){
  create_gnss_dataframe(raw_gnss[i],
                        gnss_drift_data_directory=gnss_drift_data_directory,
                        output_directory=output_directory,
                        naughty_bin_directory=naughty_bin_directory)}
