...
SWORD inputs:
•	SWORD data in the netCDF format brought in at the continental scale with centerline, node, and reach data. See SWORD Production Description PDF for detailed dataset documentation.
